  ...
  return (
    <>
      <div className="session-project">
        ...
        <div>
          ...
          <p>
            ...
            agendamento e maior assertividade para encontrar o serviço desejado.
          </p>
        </div>
      </div>
      ...
      <div className="session-project">
        ...
        <div>
          ...
          <p>
            ...
            referência), poderemos reduzir a tempo de busca e aumentar a clareza
            para os usuários, pois é comum que terminologias variadas e
            subjetivas dificultem a busca por serviços específicos. Além da
          ...
          <div className="disclaimer">
            ...
            <span>
              ...
              apenas pesquisa exploratória. O processo para um produto real deve
              se basear em dados que sustentem as hipóteses e tomadas de
              decisão.
            </span>
          </div>
        </div>
      ...
      <div className="session-project">
        ...
        <div>
          <h2 className="mobile-only">Solução Proposta</h2>
      ...
      <div className="uvp">
        ...
        <div>
          ...
          <p>
            ...
            deixarem suas unhas iguais às imagens de referência que você guarda
            no celular.”
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="desktop-only">
            <div className="disclaimer">
              <img src="/svg/disclaimer.svg" alt="disclaimer" />
              <span>
                A metodologia de desenvolvimento utilizada foi o Double Diamond,
                que organiza o processo de design em quatro etapas: descobrir,
                definir, desenvolver e entregar. Ele ajuda a entender em
                profundidade o problema antes de criar e testar soluções. O
                modelo promove a exploração de ideias e a entrega de soluções
      ...
      <div className="session-project">
        ...
        <div>
          ...
          <p>
            ...
            aumentar a satisfação dos usuários, permitindo que encontrem
          ...
          <p>
            ...
            evolução do produto. A experiência de desenvolver este projeto
            reforçou a importância de criar soluções intuitivas e focadas em
            necessidades reais, o que me inspira a continuar aprimorando minhas
            habilidades como Product Designer.
          </p>
          <h2>oportunidades para evolução</h2>
          <p>
            Em uma evolução deste projeto, desenvolveria o fluxo de agendamento
            e conversa com o prestador de serviço. O fluxo de pesquisa mais
